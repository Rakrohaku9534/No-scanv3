...
setTimeout(() => {
                     ...
                     setTimeout(() => {
                     mufar.reply(m.chat, rokit4, null)
                      }, 25000)
                
                     setTimeout(() => {
                     mufar.reply(m.chat, rokit3, null)
                     }, 20000) 
                        
                     setTimeout(() => {
                     mufar.reply(m.chat, rokit2, null)
                     }, 15000) 
                    
                     setTimeout(() => {
                     mufar.reply(m.chat, rokit, null)
                     }, 10000) 
                     
                     setTimeout(() => {
                     mufar.reply(m.chat, `🔍 ${name} Mencari Lokasi.....`, null)
                     }, 0) 
