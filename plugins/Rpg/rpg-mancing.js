...
let handler  = async (m, { mufar, command, args, usedPrefix }) => {
       let pengguna = global.db.data.users[m.sender]
       let pancingan = pengguna.pancingan
       let pemancing = await mufar.getName(m.sender)
...
//
	...
	let __timers = (new Date - pengguna.lastfishing)
        ...
        let you = mufar.getName(m.sender)
...
${ usedPrefix }cook`    
        setTimeout(() => {
        mufar.reply(m.chat, mcng, null)
         if (psepick > 0 ) {
         	pengguna.psepick += psepick * 1
         mufar.reply( m.chat, `You Get 🎁chest weapons epic ${psepick} item`, m)
         } 
        if  (psenjata > 0 ) {
        	pengguna.psenjata+= psenjata * 1
        mufar.reply( m.chat, `You Get 🎁chest weapons ${psenjata} item`, m)
        	}
        }, 38000)

        setTimeout(() => {
                     mufar.reply(m.chat, `${pemancing} Sepertinya dapat sesuatu..`, null)
                      }, 28000)
       setTimeout(() => {
                     mufar.reply(m.chat, `${pemancing} Menunggu`, null)
                      }, 8000)
       setTimeout(() => {
                     mufar.reply(m.chat, `${pemancing} Sedang Memancing...`, null)
                      }, 0)
        ...
        pengguna.nila += nila * 1
         ...
         pengguna.kepiting += kepiting * 1
           ...
           } else return mufar.reply(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, m)
           break
	          ...
	          case 'easy':
                                  ...
                                  if (pancingan == 0 || umpan == 0) return mufar.reply(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Yuk mancing mania level easy lagi`, null)
                                }, 28800000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, hsl, null)
                                }, 12000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Menunggu`, null)
                                 }, 6000) 
                                 ...
                                 } else mufar.reply(m.chat, 'Minimal umpan kamu *100* untuk memancing level mudah', m)
                            } else mufar.reply(m.chat, 'Minimal pancingan kamu *Level 2* untuk memancing level mudah', m)
                       } else mufar.reply(m.chat, `*Sepertinya Anda Sudah Lelah*\n*Silahkan Istirahat Sejenak Sekitar* ${timersa}\n*Untuk Bisa Melanjutkan Memancing Lagi*`, m)
                 break
	          case 'normal':
...
`.trim()
                                ...
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Yuk mancing mania level normal lagi`, null)
                                }, 28800000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, hsls, null)
                                }, 12000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Menunggu`, null)
                                 }, 6000) 
                                 ...
                                 pengguna.lastmancingeasy = new Date * 1
                                 } else mufar.reply(m.chat, 'Minimal umpan kamu *150* untuk memancing level normal', m)
                            } else mufar.reply(m.chat, 'Minimal pancingan kamu *Level 3* untuk memancing level normal', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Yuk mancing mania level hard lagi`, null)
                                }, 28800000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, hslsh, null)
                                }, 12000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Menunggu`, null)
                                 }, 6000) 
                                 ...
                                 pengguna.lastmancingeasy = new Date * 1
                                 } else mufar.reply(m.chat, 'Minimal umpan kamu *200* untuk memancing level hard', m)
                            } else mufar.reply(m.chat, 'Minimal pancingan kamu *Level 4* untuk memancing level hard', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Yuk mancing mania level extreme lagi`, null)
                                }, 28800000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, hslse, null)
                                }, 12000) 
                                setTimeout(() => {
                                mufar.reply(m.chat, `${pemancing} Menunggu`, null)
                                 }, 6000) 
                                 ...
                                 pengguna.lastmancingeasy = new Date * 1
                                 } else mufar.reply(m.chat, 'Minimal umpan kamu *250* untuk memancing level extreme', m)
                            } else mufar.reply(m.chat, 'Minimal pancingan kamu *Level 5* untuk memancing level extreme', m)
                       } else mufar.reply(m.chat, `*Sepertinya Anda Sudah Lelah*\n*Silahkan Istirahat Sejenak Sekitar* ${timere}\n*Untuk Bisa Melanjutkan Memancing Lagi*`, m)
                 break
                       default:
                        return mufar.sendMessage(m.chat, listMessage, {quoted: fakes})
                }
        }
    } catch (e) {
        mufar.reply(m.chat, 'Error', m)
        console.log(e)
    }
}
