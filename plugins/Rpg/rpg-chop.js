...
let handler = async (m, { mufar, usedPrefix, DevMode }) => { 
    try { 
...
💎diamond: ${diamond}
`.trim()
            await mufar.reply(m.chat, str, m)
            ...
            } else mufar.reply(m.chat, `Please wait  ${timers} again`, m)
        } else mufar.reply(m.chat, 'minimum 80 healt to do choping', m)
    } catch (e) {
        console.log(e)
