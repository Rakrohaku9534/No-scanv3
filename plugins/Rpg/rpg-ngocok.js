...
let handler = async (m, { 
mufar, usedPrefix, text, participants, groupMetadata
}) => {
    ...
    let pengocok = await mufar.getName(m.sender)
...
setTimeout(() => {
    mufar.reply(m.chat, hsl, m, { mentions: mufar.parseMention(hsl) })
                     }, 27000) 
               
                     setTimeout(() => {
                     mufar.reply(m.chat, jln4, null)
                      }, 25000)
                
                     setTimeout(() => {
                     mufar.reply(m.chat, jln3, null)
                     }, 20000) 
                        
                     setTimeout(() => {
                     mufar.reply(m.chat, jln2, null)
                     }, 15000) 
                    
                     setTimeout(() => {
                     mufar.reply(m.chat, jln, null)
                     }, 10000) 
                     
                     setTimeout(() => {
                     mufar.reply(m.chat, `🔍 ${pengocok} Mencari Area ngocok.....`, null)
                     }, 0) 
