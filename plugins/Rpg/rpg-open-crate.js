...
let handler = async (m, { mufar, command, args, text, usedPrefix }) => {
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 1) {
                        ...
                        mufar.reply(m.chat, Hcom, m)
                    } else mufar.reply(m.chat, 'Common crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastime} lagi untuk bisa membuka fitur open`, m)
                break
                case '10':
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 10) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hcom1, m)
                    } else mufar.reply(m.chat, 'Common crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimeq} lagi untuk bisa membuka fitur open`, m)
                break
                case '100':
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 100) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hcom2, m)
                    } else mufar.reply(m.chat, 'Common crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimeqq} lagi untuk bisa membuka fitur open`, m)
                break
                case '1000':
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 1000) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hcom3, m)
                    } else mufar.reply(m.chat, 'Common crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimeqqq} lagi untuk bisa membuka fitur open`, m)
                break
                default:
                    return mufar.reply(m.chat, Lmao, m)
            }
            break
        case 'uncommon':
            switch (jumlah) {
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 1) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hun, m)
                        if (umc > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += umc * 1
                        }
                    } else mufar.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimew} lagi untuk bisa membuka fitur open`, m)
                break
                case '10':
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 10) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hun1, m)
                        if (umc1 > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc1} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += umc1 * 1
                        }
                    } else mufar.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimewe} lagi untuk bisa membuka fitur open`, m)
                break
                case '100':
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 100) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hun2, m)
                        if (umc2 > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc2} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += umc2 * 1
                        }
                    } else mufar.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimewee} lagi untuk bisa membuka fitur open`, m)
                break
                case '1000':
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 1000) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Hun3, m)
                        if (umc3 > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc3} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += umc3 * 1
                        }
                    } else mufar.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimeweee} lagi untuk bisa membuka fitur open`, m)
                break
                default:
                    return mufar.reply(m.chat, Lmao ,m)
            }
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 1) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mychat, m)
                        if (mmm > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${mmm} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += mmm * 1
                        }
                        if (ml > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${ml} Legendary Crate`, m)
                            global.db.data.users[m.sender].legendary += ml * 1
                        }
                    } else mufar.reply(m.chat, 'Mythic crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimep} lagi untuk bisa membuka fitur open`, m)
                break
                case '10':
...
`.trim()
                ...
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimepa} lagi untuk bisa membuka fitur open`, m)
                break
                case '100':
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 100) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mychat2, m)
                    } else mufar.reply(m.chat, 'Mythic crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimepaa} lagi untuk bisa membuka fitur open`, m)
                break
                case '1000':
...
`.trim()
                ...
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimepaaa} lagi untuk bisa membuka fitur open`, m)
                break
                default:
                    return mufar.reply(m.chat, Lmao, m)
            }
...
`.trim()
                    ...
                    } else mufar.reply(m.chat, 'Boxs crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimed} lagi untuk bisa membuka fitur open`, m)
                break
                case '10': 
...
`.trim()
                ...
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedo} lagi untuk bisa membuka fitur open`, m)
                break
                case '100':
...
`.trim()
                ...
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedoo} lagi untuk bisa membuka fitur open`, m)
                break
                case '1000':
...
`.trim()
                ...
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedooo} lagi untuk bisa membuka fitur open`, m)
                break
...
`.trim()
                    if (global.db.data.users[m.sender].gardenboxs >= 0) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mychatzi, m)
                    } else mufar.reply(m.chat, 'gardenboxs crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedz} lagi untuk bisa membuka fitur open`, m)
                break
                case '10':
                case 'crate':
...
`.trim()
                    if (global.db.data.users[m.sender].gardenboxs >= 9) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mychatze, m)
                    } else mufar.reply(m.chat, 'gardenboxs crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedzx} lagi untuk bisa membuka fitur open`, m)
           		 break
            	case '100':
                  case 'crate':
...
`.trim()
                    if (global.db.data.users[m.sender].gardenboxs >= 99) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mychatzo, m)
                    } else mufar.reply(m.chat, 'gardenboxs crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedzxy} lagi untuk bisa membuka fitur open`, m)
                break
    			case '1000':
                 case 'crate':
...
`.trim()
                    if (global.db.data.users[m.sender].gardenboxs >= 999) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mychatzu, m)
                    } else mufar.reply(m.chat, 'gardenboxs crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimedzxyk} lagi untuk bisa membuka fitur open`, m)
                break
                default:
                    return mufar.reply(m.chat, Lmao, m)
            }
...
`.trim()*/
                    if (global.db.data.users[m.sender].cupon >= 1) {
                       ...
                       // global.db.data.users[m.sender].nabung += mc * 1
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mochat, m)
                    } else mufar.reply(m.chat, 'Cupon crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimeki} lagi untuk bisa membuka fitur open`, m)
                break
                case '10':
...
`.trim()*/
                    ...
                    //    global.db.data.users[m.sender].nabung += mcse * 1
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Mochatse, m)
                    } else mufar.reply(m.chat, 'Cupon crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimekise} lagi untuk bisa membuka fitur open`, m)
                break
                default:
                    return mufar.reply(m.chat, Lmao, m)
            }
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 1) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Lechat, m)
                        if (lmm > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += lmm * 1
                        }
                        if (ll > 0 || lpp > 0) {
                             mufar.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*${ll > 0 ? `\n${ll} Legendary Crate` : ''}${lpp > 0 ? `\n${lpp} Pet Crate` : ''}`, m)
                            global.db.data.users[m.sender].legendary += ll * 1
                            global.db.data.users[m.sender].pet += lpp * 1
                        }
                    } else mufar.reply(m.chat, 'Legendary crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimel} lagi untuk bisa membuka fitur open`, m)
                break
                case '10':
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 10) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Lechat1, m)
                        if (lmm1 > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm1} Mythic Crate`, m )
                            global.db.data.users[m.sender].mythic += lmm1 * 1
                        }
                        if (ll1 > 0 || lpp1 > 0) {
                             mufar.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*${ll1 > 0 ? `\n${ll1} Legendary Crate` : ''}${lpp1 > 0 ? `\n${lpp1} Pet Crate` : ''}`, m)
                            global.db.data.users[m.sender].legendary += ll1 * 1
                            global.db.data.users[m.sender].pet += lpp1 * 1
                        }
                    } else mufar.reply(m.chat, 'Legendary crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimele} lagi untuk bisa membuka fitur open`, m)
                break
                case '100':
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 100) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Lechat2, m)
                        if (lmm2 > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm2} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += lmm2 * 1
                        }
                        if (ll2 > 0 || lpp2 > 0) {
                             mufar.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*${ll2 > 0 ? `\n${ll2} Legendary Crate` : ''}${lpp2 > 0 ? `\n${lpp2} Pet Crate` : ''}`, m)
                            global.db.data.users[m.sender].legendary += ll2 * 1
                            global.db.data.users[m.sender].pet += lpp2 * 1
                        }
                    } else mufar.reply(m.chat, 'Legendary crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimelee} lagi untuk bisa membuka fitur open`, m)
                break
                case '1000':
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 1000) {
                        ...
                        global.db.data.users[m.sender].lastopen = new Date * 1
                        mufar.reply(m.chat, Lechat3, m)
                        if (lmm3 > 0) {
                            mufar.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm3} Mythic Crate`, m)
                            global.db.data.users[m.sender].mythic += lmm3 * 1
                        }
                        if (ll3 > 0 || lpp3 > 0) {
                             mufar.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*${ll3 > 0 ? `\n${ll3} Legendary Crate` : ''}${lpp3 > 0 ? `\n${lpp3} Pet Crate` : ''}`, m)
                            global.db.data.users[m.sender].legendary += ll3 * 1
                            global.db.data.users[m.sender].pet += lpp3 * 1
                        }
                    } else mufar.reply(m.chat, 'Legendary crate anda tidak cukup', m)
                } else mufar.reply(m.chat, `Mohon tunggu ${lastimeleee} lagi untuk bisa membuka fitur open`, m)
                break
                default:
                    return mufar.reply(m.chat, Lmao, m)
            }
        ...
        case 'pet':
            ...
            if (global.db.data.users[m.sender].pet > 0) { 
                ...
                if (_pet == 'kucing' && kucing > 0) {
                    ...
                    mufar.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} Makanan Pet` : ''}`, m)
                } else if (_pet == 'kucing' && kucing == 0) {
                    global.db.data.users[m.sender].kucing += 1
                    global.db.data.users[m.sender].makananpet += mknp * 1
                    mufar.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet} ${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : '*'}`, m)
                    ...
                    global.db.data.users[m.sender].makananpet += mknp * 1
                    mufar.reply(m.chat, randpet + 'Anda hanya mendapatkan *' + mknp + '* makanan pet', m)
                }
            } else mufar.reply('Pet Crate kamu tidak cukup')
         } else mufar.reply(m.chat, `Mohon tunggu ${lastimepet} lagi untuk bisa membuka fitur open`, m)
         break
        default:
            return mufar.reply(m.chat, bruh, m)
    }
  } 
