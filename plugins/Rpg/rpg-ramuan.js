        ...
        case 'rubah':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanrubahlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Rubah*', m)
                    }, timebah)
                    if (rubah > 0) {
        ...
        case 'kuda':
            ...
            if (new Date - global.db.data.users[m.sender].ramuankudalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Kuda*', m)
                    }, timeda)
                    if (kuda > 0) {
        ...
        case 'serigala':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanserigalalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Serigala*', m)
                    }, timela)
                    if (serigala > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakserigala > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Serigala kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Ramuan pet kamu tidak cukup`)
        ...
        case 'naga':
            ...
            if (new Date - global.db.data.users[m.sender].ramuannagalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Naga*', m)
                    }, timega)
                    if (naga > 0) {
                        ...
                        if (global.db.data.users[m.sender].anaknaga > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Naga kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Ramuan pet kamu tidak cukup`)
      ...
      case 'kyubi':
            ...
            if (new Date - global.db.data.users[m.sender].ramuankyubilast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Kyubi*', m)
                    }, timebi)
                    if (kyubi > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakkyubi > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Kyubi kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Ramuan pet kamu tidak cukup`)
      ...
      case 'centaur':
            ...
            if (new Date - global.db.data.users[m.sender].ramuancentaurlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Centaur*', m)
                    }, timeur)
                    if (centaur > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakcentaur > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Centaur kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Ramuan pet kamu tidak cukup`)
         ...
         case 'phonix':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanphonixlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Phonix*', m)
                    }, timenix)
                    if (phonix > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakphonix > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Phonix kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Ramuan pet kamu tidak cukup`)
        ...
        case 'griffin':
            ...
            if (new Date - global.db.data.users[m.sender].ramuangriffinlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Griffin*', m)
                    }, timefin)
                    if (griffin > 0) {
                        ...
                        if (global.db.data.users[m.sender].anakgriffin > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Greffin kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Ramuan pet kamu tidak cukup`)
        ...
        case 'kucing':
            ...
            if (new Date - global.db.data.users[m.sender].ramuankucinglast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan pet *Kucing*', m)
                    }, timecing)
                    if (kucing > 0) { 
        ...
        case 'hero':
            ...
            if (new Date - global.db.data.users[m.sender].ramuanherolast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi ramuan kepada ${type}`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi ramuan *Hero*', m)
                    }, timeher)
                    if (hero > 0) { 
                        ...
                        if (global.db.data.users[m.sender].exphero > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Hero kamu naik level*`, m)
                        }
                    }
            ...
            break
        default:
            return mufar.reply(m.chat, `${usedPrefix}ramuan [hero | kucing | rubah | kuda | naga | centaur | phonix | serigala]\nContoh penggunaan: *${usedPrefix}ramuan kucing*`, m)
    }
}
