...
let handler = async(m, { mufar, args, usedPrefix, command, text }) => {
...
`.trim()
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Yuk meracik lagi..', m)
                                      }, timeoutu)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, srcs, m)
                                      }, timeoutem)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk ramuan', m)
                                      }, timeoute)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, gamse, m)
                                      }, 30000)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk gems', m)
                                      }, 0)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, srcn, m)
                                      }, timeouten)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk potion', m)
                                      }, timeouto)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, srcng, m)
                                      }, timeoutel)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk string', m)
                                      }, timeoutol)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, srcngs, m)
                                      }, timeouteg)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk sword', m)
                                      }, timeoutog)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, srcngsw, m)
                                      }, timeoutwww)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk weapon', m)
                                      }, timeoutww)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, srcngsk, m)
                                      }, timeoutey)
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk iron', m)
                                      }, timeoutoy)
...
`.trim()
                                     ...
                                     setTimeout(() => {
                                          mufar.reply(m.chat, 'Mohon tunggu sedang mengaduk pancingan', m)
                                      }, timeoutoy)
                                      if (pancingan > 0) {
                                      ...
                                      mufar.reply(m.chat, `*Selamat pancingan kamu naik level*`, m)
                                      }
                                    }
                     ...
                     break
                           default:
                                  return mufar.reply(m.chat, `${usedPrefix + command} [ramuan | potion | string | iron | sword | weapon | pancingan]\nContoh penggunaan: *${usedPrefix + command} ramuan*`, m)
                           }
                        }
