        ...
        case 'fox':
            ...
            if (new Date - global.db.data.users[m.sender].foxlastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *fox*\nKarena sudah lapar..', m)
                    }, timebah)
                    if (fox > 0) {
                        ...
                        if (global.db.data.users[m.sender].foxexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet fox level up*`, m)
                        }
                    }
                ...
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    if (rhinoceros > 0) {
                        ...
                        if (global.db.data.users[m.sender].rhinocerosexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet rhinoceros level up*`, m)
                        }
                    }
                } else m.reply(`Makanan Pet Kamu Tidak Cukup`)
                ...
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    if (lion > 0) {
                        ...
                        if (global.db.data.users[m.sender].lionexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet lion level up*`, m)
                        }
                    }
                } else m.reply(`Makanan Pet Kamu Tidak Cukup`)
        ...
        case 'horse':
            ...
            if (new Date - global.db.data.users[m.sender].horselastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *horse*\nKarena sudah lapar..', m)
                    }, timeda)
                    if (horse > 0) {
                        ...
                        if (global.db.data.users[m.sender].horseexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet horse level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
        ...
        case 'wolf':
            ...
            if (new Date - global.db.data.users[m.sender].wolflastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *wolf*\nKarena sudah lapar..', m)
                    }, timela)
                    if (wolf > 0) {
                        ...
                        if (global.db.data.users[m.sender].wolfexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet wolf level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
        ...
        case 'dragon':
            ...
            if (new Date - global.db.data.users[m.sender].dragonlastclaim > 600000) {
                if (global.db.data.users[m.sender].makanandragon > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *dragon*\nKarena sudah lapar..', m)
                    }, timega)
                    if (dragon > 0) {
                        ...
                        if (global.db.data.users[m.sender].dragonexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet dragon level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
      ...
      case 'kyubi':
            ...
            if (new Date - global.db.data.users[m.sender].kyubilastclaim > 600000) {
                if (global.db.data.users[m.sender].makanankyubi > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *Kyubi*\nKarena sudah lapar..', m)
                    }, timebi)
                    if (kyubi > 0) {
                        ...
                        if (global.db.data.users[m.sender].kyubiexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet Kyubi level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
      ...
      case 'centaur':
            ...
            if (new Date - global.db.data.users[m.sender].centaurlastclaim > 600000) {
                if (global.db.data.users[m.sender].makanancentaur > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *Centaur*\nKarena sudah lapar..', m)
                    }, timeur)
                    if (centaur > 0) {
                        ...
                        if (global.db.data.users[m.sender].centaurexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet Centaur level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
         ...
         case 'phonix':
            ...
            if (new Date - global.db.data.users[m.sender].phonixlastclaim > 600000) {
                if (global.db.data.users[m.sender].makananphonix > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *Phonix*\nKarena sudah lapar..', m)
                    }, timenix)
                    if (phonix > 0) {
                        ...
                        if (global.db.data.users[m.sender].phonixexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet Phonix level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
        ...
        case 'griffin':
            ...
            if (new Date - global.db.data.users[m.sender].griffinlastclaim > 600000) {
                if (global.db.data.users[m.sender].makanangriffin > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *Griffin*\nKarena sudah lapar..', m)
                    }, timefin)
                    if (griffin > 0) {
                        ...
                        if (global.db.data.users[m.sender].griffinexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet Greffin level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
        ...
        case 'cat':
            ...
            if (new Date - global.db.data.users[m.sender].catlastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    mufar.reply(m.chat, `Feeding ${type} success`, m)
                    setTimeout(() => {
                         mufar.reply(m.chat, 'Waktunya memberi makan *cat*\nKarena sudah lapar..', m)
                    }, timecing)
                    if (cat > 0) { 
                        ...
                        if (global.db.data.users[m.sender].catexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Congratulations your pet cat level up*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
            ...
            if (new Date - user.foxlastfeed > 600000) {
                if (user.petFood > 0) {
                    ...
                    mufar.reply(m.chat, `Berhasil memberi makan pet ${type} 🦊`, m)
                    if (rubah > 0) {
                        let naiklvl = ((rubah * 100) - 1)
                        if (user.foxexp > naiklvl) {
                            user.fox += 1
                            user.foxexp -= (rubah * 100)
                            mufar.reply(m.chat, `*Selamat Pet Rubah kamu naik level ✨*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
                ...
                if (user.petFood > 0) {
                    ...
                    if (kucing > 0) {
                        ...
                        if (user.catexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Kucing kamu naik level ✨*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
                ...
                if (user.petFood > 0) {
                    ...
                    if (anjing > 0) {
                        ...
                        if (user.dogexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Anjing kamu naik level ✨*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
                ...
                if (user.petFood > 0) {
                    ...
                    if (kuda > 0) {
                        ...
                        if (user.horseexp > naiklvl) {
                            ...
                            mufar.reply(m.chat, `*Selamat Pet Kuda kamu naik level ✨*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
