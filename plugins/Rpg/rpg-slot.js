...
let frep = { contextInfo: { externalAdReply: {title: global.wm, body: global.author, sourceUrl: snh, thumbnail: fs.readFileSync('./thumbnail.jpg')}}}
    ...
    mufar.slots = mufar.slots ? mufar.slots : {}
    if (m.chat in mufar.slots) return m.reply('Masih ada Yang Melakukan Slots Disini, Tunggu Sampai selesai!!')
    else mufar.slots[m.chat] = true
    try { 
