...
let handler = async (m, { mufar, usedPrefix, command }) => {
  try {
    ...
    case 'cnn-news': {
            ...
            teks += "=============="
    mufar.sendMessage(m.chat, { text: teks }, { quoted: m });
        break;
      } 
    case 'sindo-news': {    
    ...
    mufar.sendMessage(m.chat, { text: teks }, { quoted: m });
      ...
      case 'jalantikus-meme': {
        ...
        teks += `Source: ${res}\n`;
        teks += "==============";
        mufar.sendMessage(m.chat, { image: { url: res }, caption: teks }, { quoted: m });
        break;
      }
      case 'merdeka-news': {
        ...
        teks += "==============";
        mufar.sendMessage(m.chat, { image: { url: res[0].berita_thumb }, caption: teks }, { quoted: m });
        break;
      }
            case 'cnbc-news': {
