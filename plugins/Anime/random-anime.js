...
let handler = async (m, {command, mufar, usedPrefix}) => {
...
mufar.sendFile(m.chat, haha, 'error.jpg', `_${command}_`, m)

//mufar.sendButton(m.chat, `_${command}_`.trim(), author, haha, [['🔄 𝚂𝙸𝙶𝚄𝙸𝙴𝙽𝚃𝙴 🔄', `${usedPrefix + command}`]], m) 
