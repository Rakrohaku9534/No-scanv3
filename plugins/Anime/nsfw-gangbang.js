...
let name = mufar.getName(who)
//  mufar.sendButton(m.chat, `Nih *${name}*`, botdate, pickRandom(gangbang), [['Next', `/gangbang`]],m)
mufar.sendFile(m.chat, pickRandom(gangbang), null, `Nih *${name}*`, m)
}
