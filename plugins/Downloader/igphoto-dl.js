...
const handler = async (m, { mufar, command, text, usedPrefix }) => {
  ...
  if (url_list.length > 1) {
    ...
    return mufar.sendMessage(m.chat, multiMediaMessage, 'mediaMessage');
  } else {
    ...
    return mufar.sendMessage(m.chat, imageMessage, 'imageMessage', { quoted: m });
  }
};
