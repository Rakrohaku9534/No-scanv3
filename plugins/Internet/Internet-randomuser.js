...
const handler = async (m, { mufar }) => {
  mufar.reply(m.chat, 'Sedang memuat informasi pengguna acak... Mohon tunggu sebentar', m);
  ...
  try {
    ...
    mufar.sendFile(m.chat, resizedImageBuffer, 'randomuser.jpg', `Berikut informasi pengguna acak:\n\n${userInfo}`, m);
  } catch (error) {
    mufar.reply(m.chat, 'Maaf, terjadi kesalahan. Mohon coba lagi nanti.', m);
    console.error(error);
  }
};
